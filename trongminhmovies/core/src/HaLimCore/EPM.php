...
class HaLimCore_EPM extends HaLimCore_Init
{
	...
	echo __selected("ASC", htmlspecialchars($_obfuscated_0D0A28341D073F0C1B2B12293003341915223731380E22_, ENT_QUOTES, 'UTF-8'));
        echo ">";
        _e("ASC", "halimthemes");
        echo "</option>\r\n\t            <option value=\"?page=halim-episode-manager&orderby=DESC\"";
        echo __selected("DESC", htmlspecialchars($_obfuscated_0D0A28341D073F0C1B2B12293003341915223731380E22_, ENT_QUOTES, 'UTF-8'));
        echo ">";
        _e("DESC", "halimthemes");
        echo "</option>\r\n\t            <option value=\"?page=halim-episode-manager&orderby=date\"";
        echo __selected("date", htmlspecialchars($_obfuscated_0D0A28341D073F0C1B2B12293003341915223731380E22_, ENT_QUOTES, 'UTF-8'));
        echo ">";
        _e("Date", "halimthemes");
        echo "</option>\r\n\t            <option value=\"?page=halim-episode-manager&orderby=modified\"";
        echo __selected("modified", htmlspecialchars($_obfuscated_0D0A28341D073F0C1B2B12293003341915223731380E22_, ENT_QUOTES, 'UTF-8'));
        echo ">";
		...
		echo '<span class="svitem xx"><a class="item' . esc_attr($active) . '" href="?page=halim-episode-manager&act=add_new_ep&post_id=' . esc_attr($postID) . '&server=' . esc_attr($key) . '&paged=' . esc_attr($paged) . '&cat=' . esc_attr($cat_id) . '">' . esc_html($value["halimmovies_server_name"]) . '</a><span class="del-server" data-index="' . esc_attr($key) . '"><span class="dashicons dashicons-no"></span></span></span>';
