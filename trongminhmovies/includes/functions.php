<?php
/*
 *  This code Modded By TrongMinh
 *  Website : https://trongminh.net
 */
...
class HaLimMovie_Updater_Admin
{
    ...
    public function disable_wporg_request($r, $url)
    {
        if (0 !== strpos($url, "https://api.wordpress.org/themes/update-check/1.1/")) {
            return $_obfuscated_0D190A06390328041D030F3916271D391F2F3F035C3222_;
        }
        $_obfuscated_0D330C3421170616341E2E110724293E33231236012732_ = json_decode($_obfuscated_0D190A06390328041D030F3916271D391F2F3F035C3222_["body"]["themes"]);
        $parent = get_option("template");
        $_obfuscated_0D342E1103390236250B26143C130809215B3C1E222B32_ = get_option("stylesheet");
        unset($_obfuscated_0D330C3421170616341E2E110724293E33231236012732_->themes->{$parent});
        unset($themes->themes->{$_obfuscated_0D342E1103390236250B26143C130809215B3C1E222B32_});
        $_obfuscated_0D190A06390328041D030F3916271D391F2F3F035C3222_["body"]["themes"] = json_encode($themes);
        return $_obfuscated_0D190A06390328041D030F3916271D391F2F3F035C3222_;
    }
}
