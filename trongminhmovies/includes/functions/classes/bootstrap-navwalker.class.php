...
function wp_isvl()
{
    $data = HaLimCore::halim_get_user_session_token();
    $data = json_decode(HaLimCore_AES::decrypt($data, "EZ44mFi3TlAey1b2w4Y7lVDuqO+SRxGXsa7nctnr/JmMrA2vN6EJhrvdVZbxaQs5jpSe34X3ejFKLk5Uz3slx3BrAghS1aaW5AYgWZRV0tIX5eI0yPchFz4="));
    return isvl($data);
}